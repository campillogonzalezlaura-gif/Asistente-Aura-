...
import { Send, User, Sparkles, Calendar, Info, ShieldAlert, CheckCircle2, ChevronRight, Plus, X, Clock, ChevronLeft, ChevronRight as ChevronRightIcon } from 'lucide-react';
...
export default function App() {
  ...
  // --- RENDERIZADO DE LA VISTA DE CITAS (para reutilizar en el wrapper) ---
  ...
  const KnowledgePanel = () => (
    <aside className="hidden xl:flex w-80 bg-white border-l border-natural-border flex-col p-8 overflow-y-auto shrink-0">
  ...
  const ChatView = () => (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <section ref={messagesContainerRef} className="flex-1 overflow-y-auto px-4 md:px-12 py-8 space-y-8 scrollbar-hide bg-natural-bg/30 scroll-smooth scroll-padding-bottom-4">
  ...
  return (
    <div className="min-h-screen bg-natural-bg font-sans text-natural-text flex flex-col md:flex-row overflow-hidden">
      ...
      <main className="flex-1 flex flex-col relative w-full overflow-hidden">
        ...
        {/* Wrapper interno del main: ocupa flex-1 y maneja overflow */}
